...
pub fn hoist_hid_keyboard_map() -> LayoutWithHID {
    vec![(
        ...
        [
            ...
            (
                "0x08",
                (0x88, 0x08, vec![Keyboard::LeftArrow]), // CTRL-H :: KEY_LEFT
            ),
            (
                "0x09",
                (0x89, 0x09, vec![Keyboard::Tab]), // CTRL-I :: KEY_TAB
            ),
            (
                "0x0a",
            ...
            (
                "0x15",
                (0x95, 0x15, vec![Keyboard::RightArrow]), // CTRL-U :: KEY_RIGHT
            ),
            (
                "0x16",
            ...
            (
                "0x1b",
                (0x9b, 0x1b, vec![Keyboard::Escape]), // ESCAPE :: KEY_ESC
            ),
            (
                "0x1c",
            ...
            (
                "0x22",
                (0xa2, 0x22, vec![Keyboard::LeftShift, Keyboard::Apostrophe]), // " :: SHIFT+KEY_APOSTROPHE
            ),
            (
                "0x23",
                (0xa3, 0x23, vec![Keyboard::LeftShift, Keyboard::Keyboard3]), // # :: SHIFT+KEY_3
            ),
            (
                "0x24",
            ...
            (
                "0x26",
                (0xa6, 0x26, vec![Keyboard::LeftShift, Keyboard::Keyboard7]), // & :: SHIFT+KEY_7
            ),
            (
                "0x27",
                (0xa7, 0x27, vec![Keyboard::Apostrophe]), // ' :: KEY_APOSTROPHE
            ),
            (
                "0x28",
                (0xa8, 0x28, vec![Keyboard::LeftShift, Keyboard::Keyboard9]), // ( :: SHIFT+KEY_9
            ),
            (
                "0x29",
                (0xa9, 0x29, vec![Keyboard::LeftShift, Keyboard::Keyboard0]), // ) :: SHIFT+KEY_0
            ),
            (
                "0x2a",
                (0xaa, 0x2a, vec![Keyboard::LeftShift, Keyboard::Keyboard8]), // * :: SHIFT+KEY_8
            ),
            (
                "0x2b",
                (0xab, 0x2b, vec![Keyboard::LeftShift, Keyboard::Equal]), // + :: SHIFT+KEY_EQUAL
            ),
            (
                "0x2c",
            ...
            (
                "0x2d",
                (0xad, 0x2d, vec![Keyboard::Minus]), // - :: KEY_MINUS
            ),
            (
                "0x2e",
            ...
            (
                "0x2f",
                (0xaf, 0x2f, vec![Keyboard::ForwardSlash]), // / :: KEY_SLASH
            ),
            (
                "0x30",
            ...
            (
                "0x3a",
                (0xba, 0x3a, vec![Keyboard::LeftShift, Keyboard::Semicolon]), // : :: SHIFT+KEY_SEMICOLON
            ),
            (
                "0x3b",
                (0xbb, 0x3b, vec![Keyboard::Semicolon]), // ; :: KEY_SEMICOLON
            ),
            (
                "0x3c",
                (0xbc, 0x3c, vec![Keyboard::LeftShift, Keyboard::Comma]), // < :: SHIFT+KEY_COMMA
            ),
            (
                "0x3d",
                (0xbd, 0x3d, vec![Keyboard::Equal]), // = :: KEY_EQUAL
            ),
            (
                "0x3e",
                (0xbe, 0x3e, vec![Keyboard::LeftShift, Keyboard::Dot]), // > :: SHIFT+KEY_DOT
            ),
            (
                "0x3f",
                (
            ...
            (
                "0x5e",
                (0xde, 0x5e, vec![Keyboard::LeftShift, Keyboard::Keyboard6]), // ^ :: SHIFT+KEY_6
            ),
            (
                "0x5f",
                (0xdf, 0x5f, vec![Keyboard::LeftShift, Keyboard::Minus]), // _ :: SHIFT+KEY_MINUS
            ),
            (
                "0x60",
                (0xe0, 0x60, vec![Keyboard::Grave]), // ` :: KEY_GRAVE
            ),
            (
                "0x61",
            ...
            (
                "0x79",
                (0xf9, 0x79, vec![Keyboard::Y]), // y :: KEY_Y
            ),
            (
                "0x7a",
                (0xfa, 0x7a, vec![Keyboard::Z]), // z :: KEY_Z
            ),
            (
                "0x7b",
